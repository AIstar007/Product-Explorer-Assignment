...
function SparkleIcon() {
  return (
    ...
    >
      <path
        d="m12 3 1.3 5.7L19 10l-5.7 1.3L12 17l-1.3-5.7L5 10l5.7-1.3L12 3Zm6 12 .65 2.35L21 18l-2.35.65L18 21l-.65-2.35L15 18l2.35-.65L18 15Z"
        stroke="currentColor"
        strokeWidth="1.5"
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-50">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-24 pt-8 sm:px-6 sm:pb-28 sm:pt-12 lg:px-8">
          ...
          <div className="mt-14 grid gap-12 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            >
              ...
              <h1 className="mt-4 text-5xl font-black tracking-[-0.055em] sm:text-6xl lg:text-7xl xl:text-[5.4rem] xl:leading-[0.96]">
                Product Explorer
              </h1>

              <p className="mt-6 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base sm:leading-8">
                A focused product catalogue designed for fast discovery —
                search by title, filter by category, and open any product for
                the full story.
              </p>
            </motion.div>
            ...
            {!loading && !error && (
              <motion.div
                ...
                className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-3 shadow-2xl shadow-black/10 backdrop-blur-xl"
              >
      ...
      <div className="relative mx-auto -mt-10 max-w-6xl px-4 pb-14 sm:px-6 lg:px-8">
        ...
        {!loading && error && (
          <motion.section
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-[1.75rem] border border-red-200 bg-white p-8 shadow-sm"
            role="alert"
          >
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-red-600">
                  ...
                  >
                    <path
                      d="M12 8v5m0 3h.01M10.3 4.5 2.8 18a2 2 0 0 0 1.75 3h14.9a2 2 0 0 0 1.75-3L13.7 4.5a2 2 0 0 0-3.4 0Z"
                      stroke="currentColor"
                      strokeWidth="1.7"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <button
                ...
                className="rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-slate-200"
              >
                Try again
              </button>
            </div>
          ...
          <>
            ...
            {visibleProducts.length > 0 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-12 flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.18em] text-slate-400"
              >
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-8 text-xs text-slate-400 sm:px-6 lg:px-8">
          <div>
